package com.heroxin.blog.utils;
...
public class Commons {
    ...
    public static String intro(Article article, int len) {
        ...
        if (pos != -1) {
            ...
            return com.heroxin.blog.utils.MyUtils.htmlToText(com.heroxin.blog.utils.MyUtils.mdToHtml(html));
        } else {
            String text = com.heroxin.blog.utils.MyUtils.htmlToText(com.heroxin.blog.utils.MyUtils.mdToHtml(value));
            if (text.length() > len) {
    ...
    public static String article(String value) {
        if (StringUtils.isNotBlank(value)) {
            ...
            return com.heroxin.blog.utils.MyUtils.mdToHtml(value);
        }
        return "";
    }
